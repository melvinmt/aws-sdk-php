...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * use the {@see \AwsSDK\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options AwsSDK\S3\BatchDelete options array.
     *
     * @see AwsSDK\S3\S3Client::listObjects
     ...
     *
     * @see AwsSDK\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see AwsSDK\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in AwsSDK\S3\Transfer::__construct
     *
     * @see AwsSDK\S3\Transfer for more options and customization
     */
