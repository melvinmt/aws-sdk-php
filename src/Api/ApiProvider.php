...
use AwsSDK\Exception\UnresolvedApiException;
 ...
 * {@see AwsSDK\Exception\UnresolvedApiException}.
 *
 ...
 * {@see AwsSDK\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \AwsSDK\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \AwsSDK\load_compiled_json($path);
